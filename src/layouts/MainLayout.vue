<template>
  <q-layout view="hHh lpR fFf"  >
    <q-header elevated class="header-container text-white " height-hint="98" >
      <div class="q-pa-md header-info-search">
        <div class="q-gutter-y-md column">
          <q-toolbar >
          <q-avatar class="q-mr-sm" size="4rem" >
            <img src="../assets/v4.0/FP-Iconoapp-01.png">
          </q-avatar>
            <q-input bg-color="white"  dense outlined rounded placeholder="¿Que buscas hoy?" v-model="text" size="70" input-class="text-left" class="q-ml-md">
      ...
      <q-tabs align="center" exact dense class="menu-header">
      ...
      <div class="div-breadcrumbs text-primary q-gutter-sm">
       <q-toolbar inset>
          <q-breadcrumbs align="left" active-color="gray" style="font-size: 14px">
            ...
            <q-breadcrumbs-el v-if="product && this.$route.name === 'Productos'" :label="product.product.description" />
          </q-breadcrumbs>
        </q-toolbar>
      </div>
    </q-header>
